...
pub use memory_strategy::{
    ...
    MemoryComponentKind, MemoryComponentResidency, MemoryConformanceState, MemoryDecodeRouteDomain,
    ...
    TransformerComponent, MEMORY_CALIBRATION_ABI, MEMORY_EVIDENCE_V1_PREFIX,
};
pub use registry::{
