//! Real-weights end-to-end test for Qwen3.6 **tool calling** (story 7636 — candle parity with
//! mlx-llm sc-7756). The acceptance gate for the tool-calling slice. Point `CANDLE_LLM_QWEN35_MODEL`
//! at a Qwen3.6 snapshot (the 27B works):
//!
//! ```text
//! CANDLE_LLM_QWEN35_MODEL=D:\repos\models\Qwen3.6-27B \
//!   cargo test --features cuda --test qwen35_tools -- --ignored --nocapture
//! ```
//!
