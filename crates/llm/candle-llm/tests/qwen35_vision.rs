//! Real-weights end-to-end test for Qwen3.6 **vision** (`qwen3_5` VLM, story sc-7634) — the epic
//! acceptance gate. Point `CANDLE_LLM_QWEN35_MODEL` at the 27B snapshot (the one carrying
//! `model.visual.*`):
//!
//! ```text
...
#[test]
#[ignore = "needs a Qwen3.6 27B VLM snapshot (model.visual.*) via CANDLE_LLM_QWEN35_MODEL"]
