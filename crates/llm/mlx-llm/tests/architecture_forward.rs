...
//!
//! ```text
//! SC18769_WRITE_FORWARD_GOLDEN=1 cargo test -p mlx-llm --test integration -- architecture_forward::
//! ```
        ...
        doc.insert(
            ...
            Value::String(
                "Generated by `SC18769_WRITE_FORWARD_GOLDEN=1 cargo test -p mlx-llm --test \
                 integration -- architecture_forward::`. Captured on \
                 origin/feature/sc-18755-ltx-2-5 so the values \
