...
/// [`validate_load_spec`] rejects any `quantize`, so a q4/q8 witness would name a route this crate
/// cannot load and the registry would fail the whole surface. Filter the shared helper rather than
