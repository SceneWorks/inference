...
/// Shared per-channel latent de-normalization vectors (`z = z*std + mean`) for the z16 and z48
/// Wan VAEs. The numeric definitions live in gen-core so both tensor backends use identical bits.
pub use candle_gen::gen_core::{
    QWEN_WAN_Z16_MEAN as LATENTS16_MEAN, QWEN_WAN_Z16_STD as LATENTS16_STD,
    WAN_Z48_MEAN as LATENTS_MEAN, WAN_Z48_STD as LATENTS_STD,
};
