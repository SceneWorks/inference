...
pub const KLEIN_ENCODER_CONTRACT: candle_gen::gen_core::EncoderContract =
    candle_gen::gen_core::EncoderContract {
        ...
        attention_bias: candle_gen::gen_core::EncoderConfigBool::Required(false),
        tie_word_embeddings: candle_gen::gen_core::EncoderConfigBool::Required(false),
...
pub const DEV_ENCODER_CONTRACT: candle_gen::gen_core::EncoderContract =
    candle_gen::gen_core::EncoderContract {
        ...
        attention_bias: candle_gen::gen_core::EncoderConfigBool::Optional(false),
        tie_word_embeddings: candle_gen::gen_core::EncoderConfigBool::Optional(false),
...
/// (sc-12612), mirroring `wan::config::SIZE_MULTIPLE_14B`. `validate` enforces exactly this value
/// (txt2img, control, and edit all reference this const), so the const cannot drift from the check.
    ...
    fn dev_authored_behavior_boole_must_match_the_biasless_untied_runtime() {
        for field in ["attention_bias", "tie_word_embeddings"] {
            ...
            gen_core_testkit::write_encoder_contract_fixture(&encoder, DEV_ENCODER_CONTRACT)
                .unwrap();
            DEV_ENCODER_CONTRACT
                .validate_source(&candle_gen::gen_core::WeightsSource::Dir(encoder.clone()))
            ...
            let error = DEV_ENCODER_CONTRACT
                .validate_source(&candle_gen::gen_core::WeightsSource::Dir(encoder))
                .unwrap_err()
                .to_string();
