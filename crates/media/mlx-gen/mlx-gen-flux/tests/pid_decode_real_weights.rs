...
fn flux_dev_dir() -> PathBuf {
    env_path("FLUX_DEV_DIR").unwrap_or_else(|| panic!("set FLUX_DEV_DIR to the required snapshot dir; inference never self-fetches or derives a cache location (epic 13657)"))
}
