...
/// validates its paired planner/renderer packed manifests and headers; Krea and Wan read their
/// immutable packed snapshot surfaces. Other routes return `None` rather than synthesizing a tier.
