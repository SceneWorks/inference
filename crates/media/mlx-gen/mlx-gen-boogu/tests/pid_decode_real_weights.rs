...
fn boogu_turbo_dir() -> PathBuf {
    env_path("BOOGU_TURBO_DIR").unwrap_or_else(|| panic!("set BOOGU_TURBO_DIR to the required snapshot dir; inference never self-fetches or derives a cache location (epic 13657)"))
}
