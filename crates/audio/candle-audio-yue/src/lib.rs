...
//! with `Unsupported`, so a registered provider fails closed instead of rendering placeholder
//! audio; the story named in the table replaces that module's `load` (landed: stage 2, sc-19381). Each module's deterministic,
