...
- **[LTX-2.5 access + component evidence baseline (sc-18756)](reference/sc-18756-ltx-2-5-evidence-baseline.md)** —
  epic 18755 Phase 0: measured HF access state, the reference-impl pin, the 2.3→2.5 component
  inventory (reproduced from the epic's 2026-08-11 authenticated capture), and the pre-change
  `dump-engine-capabilities` baseline every later LTX-2.5 story cites instead of re-deriving.
